...
export function SignUpPage() {
  ...
  const logos = [
    { name: 'Kaduna State', url: '/1000491869.jpg', alt: 'Kaduna State Logo' },
    { name: 'High Court', url: '/1000491875.jpg', alt: 'High Court Logo' },
  ];
        ...
        <div className="w-full bg-white rounded-xl shadow-xl border border-slate-200 overflow-hidden">
            ...
            <div className="flex justify-center mb-4 gap-8 items-center">
              {logos.map((logo, index) => (
                ...
                >
                  ...
                  <span className="text-[9px] text-slate-500 font-medium">{logo.name}</span>
                </div>
              ))}
            </div>
          ...
          <div className="p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-4 pt-4 border-t border-slate-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <Select label="Role / Position" name="role" options={[{ value: 'judge', label: 'Judge / Magistrate' }, { value: 'registrar', label: 'Court Registrar' }, { value: 'clerk', label: 'Court Clerk' }, { value: 'admin', label: 'System Administrator' }, { value: 'lawyer', label: 'Legal Practitioner' }, { value: 'auditor', label: 'Auditor' }]} value={formData.role} onChange={handleChange} required />
                  <Select label="Department" name="department" options={[{ value: 'judiciary', label: 'Judiciary (Bench)' }, { value: 'registry', label: 'Court Registry' }, { value: 'admin', label: 'Administration' }, { value: 'legal', label: 'Legal Services' }, { value: 'it', label: 'IT & Systems' }, { value: 'security', label: 'Security' }]} value={formData.department} onChange={handleChange} required />
                </div>
              </div>
          ...
          <div className="px-8 py-4 bg-slate-50 border-t border-slate-100">
            <div className="flex items-center justify-center gap-2 text-sm mb-2">
              ...
              <Link to="/login" className="text-primary hover:text-blue-700 font-medium flex items-center gap-1">
